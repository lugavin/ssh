    ...
    <form id="form" class="form-horizontal form-group-sm">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input id="name" name="name" value="${name}" type="text" class="form-control" placeholder="资源名称">
            </div>
            <div class="form-group">
                <label class="control-label" for="code">资源编码</label>
            ...
            <div class="form-group">
                ...
                <input id="url" name="url" value="${url}" type="text" class="form-control" placeholder="资源地址">
            </div>
            <div class="form-group">
                <label class="control-label" for="type">资源类型</label>
                <select id="type" name="type" class="form-control" data-provide="select2">
                    <option value="FUNC" ${type=='FUNC'?'selected':null}>功能</option>
                    <option value="MENU" ${type=='MENU'?'selected':null}>菜单</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select id="available" name="available" class="form-control" data-provide="select2">
                    <option value="1" ${available==1?'selected':null}>是</option>
                    <option value="0" ${available==0?'selected':null}>否</option>
                </select>
            </div>
            <div class="form-group">
                <label class="control-label" for="seq">排序号</label>
                <input id="seq" name="seq" value="${seq}" type="number" class="form-control" placeholder="排序号">
            </div>
            <div class="form-group">
                <label class="control-label" for="parent">上级资源</label>
                <input id="parentId" name="parentId" value="${parentId}" type="hidden">
                <input id="parent" name="parent" value="${parentId}" type="text" class="form-control"
