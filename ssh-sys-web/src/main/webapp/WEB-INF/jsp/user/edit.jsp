...
<div class="container-fluid">
    <div class="page-header">
        <label class="h4">用户管理-更新</label>
        <label class="h4 pull-right"><small>SSM-USER-EDIT</small></label>
    </div>
    <form id="form" method="post" class="form-horizontal form-group-sm">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input id="code" name="code" value="${code}" type="text" class="form-control" placeholder="用户帐号">
            </div>
            <div class="form-group">
                <label class="control-label" for="name">用户名</label>
                <input id="name" name="name" value="${name}" type="text" class="form-control" placeholder="用户名">
            </div>
            <div class="form-group">
                <label class="control-label" for="pass">密码</label>
                <input id="pass" name="pass" value="${pass}" type="password" class="form-control" placeholder="密码">
            </div>
            <div class="form-group">
